                ...
                <div class="modal-body">
                    <form id="form">
                        ...
                        <div class="form-group" id="div_warga">
                            <label for="pelapor_nik">Pekerjaan</label>
                            <input required type="text" class="form-control" id="kerja_input" name="kerja_input" placeholder="...." >
                        </div>
...
<script>
    ...
    $(document).ready( function () {
        ...
        $(document).on('click', '#add', function() {
                $('#modal').modal('show');
                $('#form').attr('action', '{{ url('pekerjaan/create') }}');
        });
        ...
        $('#form').submit(function(e) {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    data: {
                        'pekerjaan_input': $('#kerja_input').val(),
                    },
                    success :function () {
        ...
        $(document).on('click', '#edit', function() {
                ...
                $('#modal').modal('show');
                $('#kerja_input').val(data.nama).change();
                $('#form').attr('action', '{{ url('pekerjaan/update') }}/'+data.id);
        });
